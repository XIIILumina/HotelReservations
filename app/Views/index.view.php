...
?>
  <div class="h-screen center-items bg-gradient-to-r from-gray-800 from-20% via-gray-700 via%60 to-gray-600 bg-cover bg-no-repeat backdrop-blur-2xl bckdrop-rounded-3xl" >
    <div class="p-16">
    <h1 class="text-left text-5xl font-bold mb-8 text-gray-200">Hotel</h1>
      <div>
        ...
        <button class="border border-blue-500 text-white bg-gradient-to-r from-cyan-400 via-cyan-500 to-cyan-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-300 shadow-lg shadow-cyan-500/50 dark:shadow-lg dark:shadow-cyan-700/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">
          Test
            ...
            <div>
              ...
              <a href="/about">
                <button class="order border-blue-500 text-white bg-gradient-to-r from-cyan-400 via-cyan-500 to-cyan-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-300 shadow-lg shadow-cyan-500/50 dark:shadow-lg dark:shadow-cyan-700/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">
                  About
                </button>
              </a>
            </div>
