...
<div class="h-screen content-center items-center grid bg-gradient-to-r from-gray-800 from-20% via-gray-700 via%60 to-gray-600 bg-cover bg-no-repeat backdrop-blur-2xl bckdrop-rounded-3xl" >
        ...
        <div class="text-center mb-8">
            ...
            <form class="max-w-md mx-auto" method="post"?>
                ...
                <div class="mb-4 ">
                    ...
                    <a href="/user/lostPassword"><p class="text-blue-500 decoration-underline text-right ms-20">Forgot your password?</p></a>
                    <!-- Added border class -->
                </div>
                ...
                <a href="/user/register"><p class="text-blue-500 decoration-underline text-left ">Dont have an account?</p></a> 
            </form>
            <?php
